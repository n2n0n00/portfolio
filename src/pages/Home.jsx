  ...
  return (
    <div className="flex h-full w-full flex-col">
      <div className="logo m-20">
        DEVEL<span className="text-white">OPER</span>.
      </div>

      <div className="m-20 flex flex-row items-center justify-between max-[1230px]:m-10 max-[825px]:m-4 max-[825px]:flex-col-reverse max-[825px]:items-center">
